...
3. Work the next gated task in order (currently **Task 4.1** recipe enumerator + context packet). Do not create a new Morpho market. Do not start a live watcher loop.
