...
Seeded Morpho WETH/USDC market and guardian position exist — **do not invent a market id**. Phase **0.1–0.6, 1.1–1.5, 2.1–2.3, 3.1** are gated PASS. See `build2/config/verified.json` and `docs/CONTEXT.md`.
