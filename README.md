...
Seeded Morpho WETH/USDC market and guardian position exist — **do not invent a market id**. Phase **0.1–0.6, 1.1–1.5, 2.1–2.3, 3.1–3.3** are gated PASS. Latest CI green: [34889107110](https://github.com/shreyas-sovani/Moat/actions/runs/34889107110). See `build2/config/verified.json` and `docs/CONTEXT.md`.
